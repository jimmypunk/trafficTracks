...
public class TrackDetailActivity extends AbstractMyTracksActivity implements DeleteOneTrackCaller {
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    ...
    if (itemId == R.id.track_detail_stop_recording) {
      updateMenuItems(false);
      setTitle(false);
      TrackRecordingServiceConnectionUtils.stop(this, trackRecordingServiceConnection, true);
      return true;
    } else if (itemId == R.id.track_detail_insert_marker) {
      ...
      startActivity(intent);
      return true;
    } else if (itemId == R.id.track_detail_play) {
      if (isEarthInstalled()) {
      ...
      return true;
    } else if (itemId == R.id.track_detail_share) {
      ...
      return true;
    } else if (itemId == R.id.track_detail_split_frequency) {
      FrequencyDialogFragment.newInstance(R.string.split_frequency_key,
          ...
          .show(getSupportFragmentManager(), FrequencyDialogFragment.FREQUENCY_DIALOG_TAG);
      return true;
    } else if (itemId == R.id.track_detail_send_google) {
      ...
      return true;
    } else if (itemId == R.id.track_detail_save_gpx) {
      startSaveActivity(TrackFileFormat.GPX);
      return true;
    } else if (itemId == R.id.track_detail_save_kml) {
      startSaveActivity(TrackFileFormat.KML);
      return true;
    } else if (itemId == R.id.track_detail_save_csv) {
      startSaveActivity(TrackFileFormat.CSV);
      return true;
    } else if (itemId == R.id.track_detail_save_tcx) {
      startSaveActivity(TrackFileFormat.TCX);
      return true;
    } else if (itemId == R.id.track_detail_edit) {
      intent = IntentUtils.newIntent(this, TrackEditActivity.class)
          .putExtra(TrackEditActivity.EXTRA_TRACK_ID, trackId);
      startActivity(intent);
      return true;
    } else if (itemId == R.id.track_detail_delete) {
      ...
      return true;
    } else if (itemId == R.id.track_detail_sensor_state) {
      intent = IntentUtils.newIntent(this, SensorStateActivity.class);
      startActivity(intent);
      return true;
    } else if (itemId == R.id.track_detail_settings) {
      intent = IntentUtils.newIntent(this, SettingsActivity.class);
      startActivity(intent);
      return true;
    } else if (itemId == R.id.track_detail_help) {
