...
public class TrackListActivity extends FragmentActivity implements DeleteOneTrackCaller {
  ...
  private boolean handleContextItem(int itemId, long trackId) {
    ...
    if (itemId == R.id.list_context_menu_show_on_map) {
      ...
      startActivity(intent);
      return true;
    } else if (itemId == R.id.list_context_menu_edit) {
      intent = IntentUtils.newIntent(this, TrackEditActivity.class)
          .putExtra(TrackEditActivity.EXTRA_TRACK_ID, trackId);
      startActivity(intent);
      return true;
    } else if (itemId == R.id.list_context_menu_delete) {
